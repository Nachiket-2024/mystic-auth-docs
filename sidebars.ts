...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
      ...
      items: [
        ...
        'mystic_auth/authentication/oauth2-pkce',
        {
          ...
          items: [
            ...
            'mystic_auth/authentication/account-deletion/permission-protected-actions-and-purge',
      ...
      items: [
        ...
        'mystic_auth/authorization/writing-testing-policies',
        {
          ...
          items: [
            ...
            'mystic_auth/authorization/troubleshooting/valkey-and-logging',
    ...
    },
    {
      ...
      items: [
        'mystic_auth/testing/backend',
        'mystic_auth/testing/backend-authentication',
        'mystic_auth/testing/backend-authorization',
        'mystic_auth/testing/backend-integration',
        'mystic_auth/testing/backend-security-performance',
        'mystic_auth/testing/backend-unit',
        'mystic_auth/testing/backend-users-sessions',
        'mystic_auth/testing/frontend',
        'mystic_auth/testing/frontend-authentication',
        'mystic_auth/testing/frontend-authorization',
        'mystic_auth/testing/frontend-e2e',
        'mystic_auth/testing/frontend-integration',
        'mystic_auth/testing/frontend-pages-test-detail',
        'mystic_auth/testing/frontend-unit',
        'mystic_auth/testing/tooling',
      ],
    },
    {
      type: 'category',
